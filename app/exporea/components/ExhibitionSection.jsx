  ...
  return (
    <section id="exhibition" className="relative min-h-screen flex items-center justify-center overflow-hidden py-16 bg-transparent">
      ...
      >
        ...
        {/* Right Side: Features */}
        <motion.div className="w-full text-center" variants={childVariants}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
            {features.map((feature, index) => (
              <motion.div key={index} className="flex flex-col items-center text-center space-y-4 group cursor-pointer" variants={featureVariants} whileHover="hover">
                {feature.icon}
