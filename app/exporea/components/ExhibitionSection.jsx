...
export default function ExhibitionSection() {
  ...
  const features = [
    ...
    },
    {
      title: "E-Badge",
      description:
        "Quick entry with a digital badge via login or registration.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
  ...
  return (
    <section
      id="exhibition"
      className="relative min-h-screen flex items-center justify-center overflow-hidden py-16 bg-transparent"
    >
      <motion.div
      ...
      >
        ...
        <motion.div
          className="w-full md:w-1/2 mb-8 md:mb-0 flex justify-center md:justify-start"
        ...
        >
          <div className="relative w-[300px] h-[600px] drop-shadow-2xl">
            <img
              ...
              alt="iPhone Frame"
              className="absolute inset-0 w-full h-[600px] object-contain z-10"
            />
            <motion.img
              key={currentSlide}
